...
namespace PigeonGame
{
	public class Level
	{
		...
		public Level (Game1 g, World world)
		{
			...
			_level2.Add (new Enemy (_game, _world, Assets.GorillaTexture, new Vector2 (200, 150), 1, 0.2f, 8, 2, "Gorilla"));
			_level2.Add (new Enemy (_game, _world, Assets.KangerooTexture, new Vector2 (300, 50), 1, 0.2f, 8, 2, "Kangeroo"));

			_level3.Add (new Enemy (_game, _world, Assets.EagleTexture, new Vector2 (150, 50), 1, 0.2f, 8, 2, "Eagle"));
			_level3.Add (new Enemy (_game, _world, Assets.FoxTexture, new Vector2 (30, 20), 1, 0.2f, 8, 2, "Fox"));
			_level3.Add (new Enemy (_game, _world, Assets.GorillaTexture, new Vector2 (200, 150), 1, 0.2f, 8, 2, "Gorilla"));
			_level3.Add (new Enemy (_game, _world, Assets.KangerooTexture, new Vector2 (300, 50), 1, 0.2f, 8, 2, "Kangeroo"));
